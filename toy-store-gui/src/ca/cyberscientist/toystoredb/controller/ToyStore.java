...
public class ToyStore {
	/**
	 * The store menu, containing methods which are used to prompt the user for
	 * things.
	 */
	...
	/**
	 * A magic boolean value; it can have any value. It is used to select an
	 * alternate constructor with a different method signature, but the same name
	 * (ie, overloaded).
	 */
	...
	private void searchAndPurchaseMenu() {
		...
		// TODO: fix this
		purchaseIndex = 0;
		// = searchResultsTable.promptPurchaseToyOrQuit() - 1;
